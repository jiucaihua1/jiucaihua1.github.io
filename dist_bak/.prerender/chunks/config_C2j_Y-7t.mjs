import { R as NoImageMetadata, S as InvalidComponentArgs, it as AstroError } from "./errors-data_21Mj7k88.mjs";
...
var astro_paper_config_default = defineAstroPaperConfig({
	site: {
		url: "https://jiucaihua1.github.io/",
		title: "jiucaihua1's Blog",
		description: "个人技术博客，记录学习与思考。",
		author: "jiucaihua1",
		profile: "https://github.com/jiucaihua1",
	...
	features: {
		...
		editPost: {
			enabled: true,
			url: "https://github.com/jiucaihua1/jiucaihua1.github.io/edit/main/"
		},
		search: "pagefind"
	},
	socials: [{
		name: "github",
		url: "https://github.com/jiucaihua1"
	}, {
		name: "mail",
		url: "mailto:766592805@qq.com"
	}],
	shareLinks: [
		{
			name: "whatsapp",
